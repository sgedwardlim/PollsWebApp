...
class QuestionTestCase(TestCase):
    ...
    def test_was_published_recently_with_future_qustion(self):
        """
        This test case should return FALSE if an entry that was created in the time
        in the future
        """
        time = timezone.now()
    ...
    def test_was_published_recently_with_old_question(self):
        """
        This test case should return FALSE if an entry was created in the past
        more then a day old
        """
        time = timezone.now()
        old_question = Question(pub_date=time + datetime.timedelta(days=1))
        self.assertIs(old_question.was_published_recently(), False)

    def test_was_published_recently_with_recent_question(self):
        """
        This test case should return TRUE if an entry was created within a day
        """
        time = timezone.now()
